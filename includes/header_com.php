...
<head>
    ...
    <!-- Font Awesome Icons -->
    <script src="./assets/js/fontawesome.com.42d5adcbca.js" crossorigin="anonymous"></script>
    ...
    <!-- All Internal Css moved into new.css -->
    ...
    <link href="./assets/css/fonts.googleapis-ch.css" rel="stylesheet">
