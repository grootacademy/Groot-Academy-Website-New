        ...
        <div class="row">
            <div class="col-lg-12 mx-auto">
                <div class="mb-4 w-100">
                    ...
                    <h4 class="course-heading"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/d/d7/ios_robot.svg/1745px-Android_robot.svg.png" alt="image" width="50" style="border-radius: 10px;"/> ios Application Development</h4> 
                </div>
        ...
        '></iframe>
                ...
                <div class="row">
                            ...
                            <select class="form-select" id="floatingSelect" aria-label="Floating label select example">
                                ...
                                <option disabled>What is ios?</option>
                                <option disabled >ios Features ?</option>
                            ...
                            <label style="color: black" class="mt-2 text-lg" for="floatingSelect">Introduction to ios</label>
                            </div>
                            <div class="form-floating">
                            <select class="form-select" id="floatingSelect" aria-label="Floating label select example">
                                
                                <option disabled>Introduction</option>
                                <option disabled >A brief history of ios</option>
                                <option disabled >What is ios?</option>
                                <option disabled >Why is ios important?</option>
                                <option disabled >What benefits does ios have?</option>

                                <option disabled >What is ios?</option>
                                <option disabled >Why to choose ios?</option>
                                <option disabled >Software architecture of ios</option>
                                <option disabled >Advantages of ios</option>
                                <option disabled >ios features ios market</option>
                                <option disabled>Comparing ios with other platform</option>
