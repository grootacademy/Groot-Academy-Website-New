    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-7 text-center mx-auto">
          ...
          <a href="./contact-us" target="_blank" class="text-light btn btn-outline-white mt-5 up btn-round">Join Us For IT Training</a>
...
<section class="pt-12 pb-4" id="count-stats">
  <div class="container">
    <div class="row">
    ...
    <div class="row align-items-center">
      <div class="col-lg-6 ms-auto">
        ...
        <div class="row justify-content-start mt-5">
          ...
          <!--    <h5 class="font-weight-bolder mt-3">Placement Assistance</h5>-->
          <!--    <p class="pe-3">We also have a dedicated placement cell to help our students land at good jobs.</p>-->
      ...
      <div class="col-lg-4 ms-auto me-auto p-lg-4 mt-lg-1 mt-4">
        <div class="card card-background card-background-mask-primary tilt" data-tilt>
          ...
          <div class="card-body pt-0 text-center">
            <div class="icon icon-lg up mb-3 mt-2">
                ...
                <center>
                  <div class="tab-content tab-space mt-3">
                    <div class="tab-pane active" id="preview-modal">
                      <a href="./contact-us" style="font-family: 'Chivo', sans-serif;"> <button type="button" class="btn bg-gradient-primary">
                          Contact Us
                        </button></a>
                    </div>
                  </div>
      ...
      <div class="carousel-inner" role="listbox">
        <div class="carousel-item active">
          <div class="col-md-3">
            <div class="card">
              <div class="card-img">
                <img src="images/style2/1.png" width="200" class="">
              </div>
        ...
        <div class="carousel-item">
          <div class="col-md-3">
            <div class="card">
              <div class="card-img">
                <img src="images/style2/2.png" width="200">
              </div>
        ...
        <div class="carousel-item">
          <div class="col-md-3">
            <div class="card">
              <div class="card-img">
                <img src="images/style2/3.png" width="200">
              </div>
        ...
        <div class="carousel-item">
          <div class="col-md-3">
            <div class="card">
              <div class="card-img">
                <img src="images/style2/4.png" width="200">
              </div>
          ...
          <div class="col-md-3">
            <div class="card">
              <div class="card-img logo-img">
                <img src="images/style2/5.png" width="180" alt="">
                <a>
        ...
        <div class="carousel-item">
          <div class="col-md-3">
            <div class="card">
              <div class="card-img">
                <img src="images/style2/6.png" width="200">
              </div>
...
<!-- <div class="w3-content w3-section" style="max-width:500px">
  ...
  <img class="mySlides w3-animate-fading" src="./assets/img/slide3" style="width:100%">
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-5 me-lg-auto my-lg-auto text-lg-end mt-5">
        ...
        <a href="http://web.whatsapp.com/send?text=<?php urlencode('This is WhatsApp sharing example using link') ?> https://www.grootacademy.com/" data-action="share/whatsapp/share" target="_blank" class="btn btn-success mb-0 me-2">
