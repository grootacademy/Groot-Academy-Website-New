...
<body>
      ...
      <div class="col-md-8 col-sm-12 col-xs-12" style="background-image: url(./img/Rectangle.png); padding: 100px; border-radius: 0px 0px 100px 0px;">
        ...
        <div class="container">
          <div class="box">
            ...
            <h1 class="head1">
              Ready to Take Your Programming Skills to the Next Level? Sign Up for Our Programming Language Training Institute.
            </h1>
            <p class="para">Learn in-demand languages and accelerate your career growth. Unleash your coding potential and build innovative projects</p>
        ...
        <div class=" premain">
          ...
          <div class="cont">
            <div class="col-md-4 col-sm-12 col-xs-12 ">
              ...
              <div class="main">
                <div class="sub-main">
                  <img src="./img/image 9.png" class="img1">
                </div>
  ...
  <div class="row our" id="sec3">
    ...
    <!-- <div class="col-md-4 col-sm-12 col-xs-12 ">
      <div class="item1">
        <h1 class="item1-head">Our</h1>
        <h1 class="item1-head">Achievements</h1>
        <p class="item1-para">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Similique accusamus ut quis
          provident tempora illo, eveniet pariatur earum delectus dolores aliquid totam dignissimos placeat!</p>
      </div>
    </div> -->
    ...
    <div class="col-md-4 col-sm-12 col-xs-12 ">
      <div class="item3">
        ...
        <div class="round1">
          <h4 class="item2-head">Course Details:</h4>
          <p class="item2-para">
    ...
    <div class="col-md-4 col-sm-12 col-xs-12 ">
      <div class="item3">
        <div class="round">
          <i class="fa-solid fa fa-sun-o"></i>
        </div>
        <div class="round1">
      ...
      <div class="row">
        ...
        <div class="col-md-6" style="margin-top: 100px;">
          <div class=" container text-light">
            ...
            <br><br>
            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Voluptatibus illo alias exercitationem impedit
              atque itaque vitae laborum facilis eligendi ipsam! Sint eum illo, quas quae vero at laboriosam iste
              corrupti.</p>
        ...
        <div class="col-md-6" style="margin-top: 100px;">
          <div class="dotted-back">
            <img class="workspace" src="./img/workspace.png" style="margin-left: 170px;" width=" 50%">
          </div>
        </div>
  ...
  <div class="container">
    <div class="row">
      <section id="sec2">
        <div class=" premain">
          <div class="col-12 fac">
            <!--<h1 class="pre-head">Our Faculty</h1>-->
            <!--<p class="pre-para" style=" line-height: 2.7;">Lorem ipsum is common placeholder text used to demonstrate the </p>-->

            <!--<p class="pre-para"  style=" line-height: 2.7;"> graphic elements of a document or visual presentation.</p>-->
            <br><br>
          </div>
          <div class="cont">
            <div class="col-md-4 col-sm-12 col-xs-12 ">
              ...
              <div class="main">
                <div class="sub-main">
                  <img src="./img/image 11.png" class="img1">
                </div>
  ...
  <div class="container">
    ...
    <!--    <div class=" premain">-->
    <!--      <div class="col-12">-->
    <!--        <h1 class="pre-head">Our Customers</h1>-->
    <!--        <p class="pre-para">Lorem ipsum is common placeholder text used to demonstrate the </p>-->

    <!--        <p class="pre-para"> graphic elements of a document or visual presentation.</p>-->
    <!--        <br><br>-->
    <!--      </div>-->
    <!--      <div class="cont">-->
