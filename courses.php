                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-6 mt-md-0">
                            <a href="./course-back-end-development-with-nodejs.php">
                                <div class="card shadow-lg move-on-hover min-height-160 min-height-160">
                                    <img src="./assets/img/groot-tech-logos/node-js-logo-by-groot-academy.png"
                                        width="256px">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-6 mt-md-0">
                            <a href="./course-c-programming-and-c-plus-plus-programming.php">
                                <div class="card shadow-lg move-on-hover min-height-160 min-height-160">
                                    <img src="./assets/img/groot-tech-logos/c-and-c++-programming-logo-by-groot-academy.png"
                                        width="256px">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-6 mt-md-0">
                            <a href="./course-spring-mvc.php">
                                <div class="card shadow-lg move-on-hover min-height-160 min-height-160">
                                    <img src="./assets/img/groot-tech-logos/groot-academy-spring-mvc-logo.png"
                                        width="210px">
