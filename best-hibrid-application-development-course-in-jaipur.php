    ...
    <div class="row">
        <div class="col-lg-12 mx-auto">
            <div class="mb-4 w-100">
                ...
                <h4 class="course-heading"><img src="./assets/img/java.png" alt="image" width="50" style="border-radius: 10px;" /> Core hybrid mobile app Course Training In Jaipur
                </h4>
            </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12">
        ...
        <h6>
        hybrid mobile app Training will help you to find good job or create chance for your promotion. We have plenty of experienced professional instructors who will teach you at best level with live project that will help you to implement new stuffs. We designed this hybrid mobile app course according to current demand of software industry. 🍎🌟</h6>
