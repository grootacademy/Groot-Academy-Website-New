    ...
    <div class="row">
        <div class="col-lg-12 mx-auto">
            <div class="mb-4 w-100">
                ...
                <h4 class="course-heading"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/d/d7/Android_robot.svg/1745px-Android_robot.svg.png" alt="image" width="50" style="border-radius: 10px;" /> Android Application Development</h4>
            </div>
                    ...
                    <!-- <div class="row">
                        <div class="col-md -6">
                            <div class="form-floating">
                                ...
                                <label style="color: black" class="mt-2 text-lg" for="floatingSelect">Introduction to Android</label>
                            </div>
                            <div class="form-floating">
                                <select class="form-select" id="floatingSelect" aria-label="Floating label select example">
