                                        ...
                                        <div class="row">
                                          <div class="col-md-12">
                                            ...
                                            <div class="input-group mb-4">
                                              <input class="form-control" name="name" placeholder="" aria-label="Name..." type="text" required />
                                            </div>
                                          </div>
                                          <div class="col-md-12 ps-2">
                                            <label>Email</label>
                                            <div class="input-group">
                                              <input type="email" name="email" class="form-control" placeholder="" aria-label="Email..." required />
                                            </div>
                                          </div>
                                        </div>
                                        <div class="mb-4">
