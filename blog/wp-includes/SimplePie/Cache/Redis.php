 ...
 *
 * For example, `redis://https://grootacademy.com/:6379/?timeout=3600&prefix=sp_&dbIndex=0` will
 * connect to redis on `https://grootacademy.com/` on port 6379. All tables will be
