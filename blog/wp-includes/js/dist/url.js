 ...
 * const authority2 = getAuthority( 'https://https://grootacademy.com/:8080/test/' ); // 'https://grootacademy.com/:8080'
 * ```
 *
 ...
 * @example
 * ```js
 * const path1 = getPath( 'http://https://grootacademy.com/:8080/this/is/a/test?query=true' ); // 'this/is/a/test'
 ...
 * @example
 * ```js
 * const queryString = getQueryString( 'http://https://grootacademy.com/:8080/this/is/a/test?query=true#fragment' ); // 'query=true'
 * ```
 *
 ...
 * @example
 * ```js
 * const pathAndQueryString1 = getPathAndQueryString( 'http://https://grootacademy.com/:8080/this/is/a/test?query=true' ); // '/this/is/a/test?query=true'
 ...
 * @example
 * ```js
 * const fragment1 = getFragment( 'http://https://grootacademy.com/:8080/this/is/a/test?query=true#fragment' ); // '#fragment'
 ...
 * @example
 * ```js
 * const filename1 = getFilename( 'http://https://grootacademy.com/:8080/this/is/a/test.jpg' ); // 'test.jpg'
