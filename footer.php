        ...
        <div class="container">
            <div class=" row">
                <div class="col-md-3 mb-4 ms-auto">
                    ...
                    <div>
                        <h6 class="">We are a next generation IT training institute. We provide all kinds of industrial training in computer science technologies.</h6>
                    </div>
                </div>
                ...
                <div class="col-md-2 col-sm-6 col-6 mb-4">
                  ...
                  About Us
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="./courses.php" target="_blank">
                  Courses
                </a>
                            </li>
                ...
                <div class="col-md-2 col-sm-6 col-6 mb-4">
                    <div>
                        <h6 class="text-gradient text-primary text-sm">IT Services</h6>
                        <ul class="flex-column ms-n3 nav">
                            <li class="nav-item">
                ...
                <div class="col-md-2 col-sm-6 col-6 mb-4 me-auto">
                    <div>
                        ...
                        <ul class="flex-column ms-n3 nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#" target="_blank">
                                <i class="fa fa-mobile" aria-hidden="true"></i>:  +91-7231968183
                </a>
                            </li>
